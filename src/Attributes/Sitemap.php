 ...
 *
 * Last modified by "IDMarinas" on 05/12/2025, 16:29
 *
...
final class Sitemap implements SitemapInterface
{
	 ...
	 *
	 * @param string                   $priority       The priority value for sitemap entries. For dynamic sitemaps, this
	 ...
	 * @param string|null              $name           The unique identifier for this sitemap section. When provided
	 ...
	 *                                                 the value can be:
	 *                                                 - Prop: to access an entity property using PropertyAccess component
